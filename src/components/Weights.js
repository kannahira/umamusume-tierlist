          ...
          <>
            <div className="weight-row">
              ...
              <div class="section-explanation">
                Which scenario you're playing in.
                <br />
            ...
            <div className="weight-row">
              ...
              <div class="section-explanation">
                ...
                <br />
                This is the bond over every card, so 14 = two cards per day,
                etc.
              </div>
            ...
            <div className="weight-row">
              ...
              <div class="section-explanation">
                How many of each optional race class you do, for calculating
                Race Bonus points.
              </div>
            ...
            <div className="weight-row">
              ...
              <div class="section-explanation">
                Multiplier accounts for MANT items and GL friendship songs.
                <br />
            ...
            <div className="weight-row">
              ...
              <div class="section-explanation">
                This will cap the stat gain, penalizing cards that only raise
                one stat.
                <br />
                Lower this if you tend to cap your stats very early to
                strengthen cards that raise multiple.
              </div>
              <input
                type="range"
            ...
            <div className="weight-row">
              ...
              <div class="section-explanation">
                Any training combination that gives less than this will be
                ignored.
                <br />
                Increase this to ignore trainings you wouldn't do, such as lone
                rainbows.
                <br />
                Solo MLB Kitasan rainbow is about 40, depending on the weights,
                for reference.
              </div>
              <input
                type="range"
            ...
            {this.state.currentState !== 'friend' && (
              <div className="weight-row">
                ...
                <div class="section-explanation">
                  If this option is disabled, then single rainbows in this stat
                  <br />
                  will be ignored if any other stat is rainbowing at the same
                  time.
                </div>
                <input
                  type="checkbox"
                ...
                <div class="section-explanation">
                  If this option is enabled, then all rainbows will be ignored
                  <br />
                  in this stat unless it's summer. Assumes 8 summer turns. Sorry
                  Bakushin.
                </div>
                <input
                  type="checkbox"
